...
export class ChatDataProvider implements vscode.WebviewViewProvider {
    ...
    private getWebviewContent(webview: vscode.Webview, extensionUri: vscode.Uri): string {
      ...
      const cssUri = webview.asWebviewUri(vscode.Uri.joinPath(extensionUri, 'resources', 'chat-view', 'chat.css'));
      const jsUri = webview.asWebviewUri(vscode.Uri.joinPath(extensionUri, 'resources', 'chat-view', 'chat.js'));
      const markedUri = webview.asWebviewUri(vscode.Uri.joinPath(extensionUri, 'resources', 'chat-view', 'marked.min.js'));
